...
class SpeedSample:
    ...
    def age_seconds(
        ...
        return (
            ...
            - self.measured_at_utc.astimezone(
                timezone.utc
            )
        ).total_seconds()
...
class SpeedProvider(Protocol):
    """
    Interface implemented by GNSS and future
    robot-controller speed inputs.
    """
    ...
    def sample(
        ...
        """
        Return the newest speed sample or None
...
class GnssSpeedProvider:
    """
    Read speed directly measured in the latest
    applicable GNSS RMC fix.
    """
